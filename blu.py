...
class BluUI:
    def __init__(self, root):
        ...
        self.width = dim[0]
        self.height = dim[1]
        self.my_parser = MyParser(dim[0], dim[1])
    ...
    def create_widgets(self):
        ...
        compile_button.bind("<Button-1>", lambda event: self.compile_code())
    ...
    def compile_code(self):
        ...
        self.result_text.insert(self.result_text.index("end"), self.my_parser.parse(code))
